...
class birthday(commands.Cog):
    def __init__(self, bot: commands.Bot):
        ...
        @verjaardag.sub_command(description = "Voeg je verjaardag toe aan Adje!")
        ...
        async def toevoegen(
            ...
            res = check_xp(id=inter.author.id)
            ...
            await log_command(author=inter.author, command="`/verjaardag toevoegen`", channel=inter.channel)
        ...
        async def verwijderen(inter):
            ...
            await log_command(author=inter.author, command="`/verjaardag verwijderen`", channel=inter.channel)
        ...
        def check_xp(id):
            try:
                ...
                print(f"DEBUG birthday funtion 'check_cp', error: {error}")
        ...
        async def birthday_send_embed(id, age):
            try:
                channel_to_send = bot.get_channel(int(birthday_cog.BIRTHDAY_EMBED_CHANNEL_ID))
